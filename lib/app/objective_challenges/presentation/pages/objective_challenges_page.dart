...
class ObjectiveChallengesPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final progress = ref
        .watch(playerProgressViewModelProvider)
        .maybeWhen(data: (progress) => progress, orElse: PlayerProgress.empty);

    return Scaffold(
      body: AppPageFrame(
        scrollKey: const ValueKey('objective-challenges-page'),
        sliverBuilder: (context, constraints) {
          ...
          return [
            SliverPadding(
              ...
              sliver: SliverToBoxAdapter(
                child: AppPageHeader(
                  title: context.l10n.objectiveChallengesTitle,
            ...
            SliverPadding(
              ...
              sliver: SliverToBoxAdapter(child: const _ObjectiveHeroCard()),
            ),
            SliverPadding(
              padding: const EdgeInsets.fromLTRB(
                AppSpacing.lg,
              ...
              data: (levels) => SliverPadding(
                ...
                sliver: SliverGrid(
                  ...
                  delegate: SliverChildBuilderDelegate((context, index) {
                    ...
                    final stars =
                        progress.objectiveStarsByLevel[level.level] ?? 0;
                    final previousStars = level.level == 1
                        ? 1
                        : progress.objectiveStarsByLevel[level.level - 1] ?? 0;
            ...
            const SliverPadding(
              ...
              sliver: SliverToBoxAdapter(child: _ObjectiveFutureLevelsNote()),
            ),
          ];
        },
      ),
